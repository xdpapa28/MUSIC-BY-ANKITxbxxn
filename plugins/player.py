...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 Ƥɭɘɑsɘ ❤️ Ɱɑŋʋɑɭɭy 🥀ᴀɗɗ 💫ᴀssɩsʈɑŋʈ ** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/022ffcf812dd6d45816fe.jpg"
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="**🥀 ᴡᴀɪᴛ ᴀ ᴍɪɴᴜᴛᴇ❗️\n🔊ᴀʈ 💞 Ƥøsɩʈɩøɳ » `{}` 🌷 ...**".format(position),
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/022ffcf812dd6d45816fe.jpg", 
                             caption="**ᴀɴᴋɪᴛ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**🥀 ɴᴏᴛʜɪɴɢ ᴛᴏ ᴘʟᴀʏ ...**")
    else:
